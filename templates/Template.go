...
func withPackageDir(fileName string, schema *core.Schema, context *core.Context, camelCase bool) string {
	if schema.Options[core.WithPackageDir] != "" || context.Options[core.WithPackageDir] != "" {
		if camelCase {
			return toCamelCase(schema.Package, string(os.PathSeparator)) + string(os.PathSeparator) + fileName
		}
